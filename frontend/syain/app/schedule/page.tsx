...
import { getLessonSchedules, getCalendarSchedules, LessonSchedule, CalendarEvent, ScheduleSearchParams } from '@/lib/api/lessons';
import {
  Calendar,
  Clock,
  MapPin,
...
export default function SchedulePage() {
  ...
  const fetchListData = useCallback(async () => {
    try {
      ...
      const response = await getLessonSchedules(params);
  ...
  const fetchCalendarData = useCallback(async () => {
    try {
      ...
      const events = await getCalendarSchedules({
  ...
  }, [authLoading, viewMode, fetchListData, fetchCalendarData]);
